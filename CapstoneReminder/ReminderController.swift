...
class ReminderController {
    ...
    var mockReminders: [Reminder]  {
        ...
        let r1 = Reminder(title: "Pay Rent", notes: "Mock Notes Mock Notes Mock Notes Mock Notes Mock Notes Mock Notes Mock Notes Mock Notes Mock Notes Mock Notes Mock Notes Mock Notes Mock Notes Mock Notes Mock Notes ")
